class ImportMailer < ApplicationMailer
  ...
  def successful_import_email(files, user_email, root_url)
    ...
    mail(to:"#{user_email},jennifer.lindner@northwestern.edu", from: "repository@northwestern.edu", subject: "Your Menu job has been successfully imported", body: @body)
  end
    ...
    #need user who invoked delayed_job
    mail(to:"#{user_email},jennifer.lindner@northwestern.edu", from: "repository@northwestern.edu", subject: "Your Menu job did not get imported", body: @body)
  end
end
