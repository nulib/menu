...
<vra:image>
 <vra:relationSet>
   <vra:relation pref="true" type="imageIs"/>
    ...
    work_xml = ImagesHelper.transform_image_into_work( image_xml )
...
<vra:work>
 <vra:relationSet>
  ...
  it "gets the pid from the response for the work record" do
    ...
    pid = ImagesHelper.get_pid_from_response( resp )
...
<vra:image>
 <vra:relationSet>
   <vra:relation />
    ...
    work_pid = 'inu:test-work-pid-536679ef-f55a-455f-a638-2c3887c44e19'
    image_xml = ImagesHelper.add_relation_to_image( image_xml, work_pid )
...
<vra:work>
 <vra:relationSet>
   <vra:relation />
    ...
    work_pid = 'inu:test-work-a6e58884-cf1c-4fac-8273-183fee8e9615'
    image_pid = 'inu:test-image-pid-536679ef-f55a-455f-a638-2c3887c44e19'
    image_xml = ImagesHelper.add_refid_and_relation_to_work( work_xml, image_pid, work_pid )
    expect( image_xml ).to eql('<?xml version="1.0"?>
<?xml-stylesheet type="text/css" href="vraCore.css" ?>
<vra:vra xmlns:madsrdf="http://www.loc.gov/mads/rdf/v1#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:mods="http://www.loc.gov/mods/v3" xmlns:vra="http://www.vraweb.org/vracore4.htm" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xsi:schemaLocation="http://www.vraweb.org/vracore4.htm http://www.vraweb.org/projects/vracore4/vra-4.0-restricted.xsd">
...
<vra:image>
    ...
    image_pid = 'inu:test-image-a6e58884-cf1c-4fac-8273-183fee8e9615'
    image_xml = ImagesHelper.add_refid_to_image( image_xml, image_pid )
    expect( image_xml ).to eql('<?xml version="1.0"?>
<?xml-stylesheet type="text/css" href="vraCore.css" ?>
<vra:vra xmlns:madsrdf="http://www.loc.gov/mads/rdf/v1#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:mods="http://www.loc.gov/mods/v3" xmlns:vra="http://www.vraweb.org/vracore4.htm" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xsi:schemaLocation="http://www.vraweb.org/vracore4.htm http://www.vraweb.org/projects/vracore4/vra-4.0-restricted.xsd">
